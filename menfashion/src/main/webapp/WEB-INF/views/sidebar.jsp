...
<div class="sidebar">
    ...
    <a href="/ban-hang">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart"
             viewBox="0 0 16 16">
            <path d="M0 1.5A.5.5 0 0 1 .5 1h1a.5.5 0 0 1 .485.379L2.89 5H14.5a.5.5 0 0 1 .491.592l-1.5 7A.5.5 0 0 1 13 13H4a.5.5 0 0 1-.491-.408L1.01 2H.5a.5.5 0 0 1-.5-.5zm3.14 6 1.2 6h7.32l1.2-6H3.14zM5.5 12a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm6 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
        </svg>
        Bán hàng
    </a>
    ...
    <a href="/san-pham">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-seam"
             viewBox="0 0 16 16">
            <path d="M3.67 3.7L8 5.383l4.33-1.683L8 2.017 3.67 3.7zM2.5 4.5v7l4.5 1.75v-7L2.5 4.5zm5 8.25L12.5 11.5v-7l-4.5 1.75v7zm6-8.25l-4.5 1.75v7l4.5-1.75v-7z"/>
        </svg>
        Sản phẩm
    </a>
    ...
    <a href="/san-pham-chi-tiet">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-card-list"
             viewBox="0 0 16 16">
            <path d="M14 4.5V14a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4.5h13zm0-1H1.5A1.5 1.5 0 0 0 0 5v9a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V5a1.5 1.5 0 0 0-1.5-1.5zm-9 2a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h1zm0 3a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h1zM4.5 8v1h1V8h-1zm0 3v1h1v-1h-1z"/>
            <path d="M7 5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1H7zm0 3a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1H7zm0 3a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1H7z"/>
        </svg>
        Sản phẩm chi tiết
    </a>
    ...
    <a href="/kich-thuoc">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-rulers"
             viewBox="0 0 16 16">
            <path d="M12 1.5V0h-1.5v1H8V0H6.5v1H4V0H2.5v1H1v.5h2.5v1H4v2h2V1.5h.5V2H8v1.5h.5V2H12V1.5zm-2.5 7V5.5H8V6H6.5V4.5H6v1.5H4.5V5.5H4v1.5H2.5V7H4v1.5H2.5V9H4v1.5h1.5V8H6v1.5H7v1H9v1.5H10v-1.5H12v1.5H13.5V10h1v-.5h1V9h-2.5v-1H11.5V7H12v-.5h1.5V5H12V4h-1.5v-.5H10V4H8.5V5H6.5v1.5H8V6H9v2.5z"/>
        </svg>
        Kích thước
    </a>
    ...
    <a href="/khach-hang">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person"
            ...
            <path d="M14 14s-1-2-6-2-6 2-6 2V12s1-1 6-1 6 1 6 1v2z"/>
        </svg>
        Khách hàng
    </a>
    ...
    <c:if test="${isAdmin}">
        <a href="/nhan-vien">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people"
                 viewBox="0 0 16 16">
                <path d="M13 14s-1-1-5-1-5 1-5 1v1h10v-1zM6.5 10a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5zm5 0a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5zm-5 1c1.933 0 5 .67 5 2v1h-10v-1c0-1.33 3.067-2 5-2z"/>
            </svg>
            Nhân viên
        </a>
        ...
        <a href="/hoa-don">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-receipt"
                 viewBox="0 0 16 16">
                <path d="M2 1v14l2-2 2 2 2-2 2 2 2-2 2 2V1H2zm12 0h1v13.535l-.793-.792a1 1 0 0 0-1.414 0l-.793.792H2.707l-.793-.792a1 1 0 0 0-1.414 0L1 14.535V1h1v12.59L2 12.59l1 .707v-12.59h8v12.59l1-.707 1 .707V1zm-1 0h1v12h-1V1z"/>
            </svg>
            Hóa đơn
        </a>
