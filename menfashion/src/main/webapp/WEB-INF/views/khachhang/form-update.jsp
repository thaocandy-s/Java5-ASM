...
<div class="container mt-5">
    ...
    <form action="/khach-hang/update" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="ma" name="ma" value="${rp.data.ma}" readonly>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input" id="active" name="trangThai" value="ACTIVE" ${rp.data.trangThai == 'ACTIVE' ? 'checked' : ''}>
